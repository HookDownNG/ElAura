...
export default function NewCampaignPage() {
  ...
  useEffect(() => {
    async function load() {
      ...
      if (prof.role !== "brand") { router.push("/dashboard"); return }
      setProfile(prof)
      setLoading(false)
    }
    load()
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Provide the basic information about your campaign</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="title">Campaign Title *</Label>
                <Input id="title" name="title" placeholder="e.g. Summer Fashion Campaign 2026" required />
              </div>
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                <Label htmlFor="guidelines">Guidelines / Brief (Optional)</Label>
                <Textarea
                  id="guidelines"
                  name="guidelines"
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Break your campaign budget into milestones. Total: {formatCurrency(totalBudget)}
                </CardDescription>
              </div>
              ...
              {milestones.map((milestone, index) => (
                <div key={index} className="rounded-lg border border-border p-4 space-y-3">
                  ...
                  <div className="grid gap-3 sm:grid-cols-2">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor={`milestone-amount-${index}`}>Amount (NGN) *</Label>
                      <Input
