  ...
  async function handleSubmit() {
    if (!content.trim() && externalUrls.every((u) => !u.trim())) {
      addToast({
        ...
        description: "Please provide content or at least one URL.",
        variant: "destructive",
      });
      return;
    }
        ...
        {isCreator && isFunded && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Upload your deliverables for this milestone. You can provide
                text, external URLs, or file uploads.
              </CardDescription>
            </CardHeader>
        ...
        {isCreator && !isFunded && milestone.state !== "UNDER_REVIEW" && (
          <Card>
            <CardContent className="py-8 text-center">
              <p className="text-muted-foreground">
                {milestone.state === "UNFUNDED" &&
                  "This milestone has not been funded yet. Wait for the brand to fund it."}
                {milestone.state === "COMPLETED" &&
                  "This milestone has been completed and funds released."}
                {milestone.state === "DISPUTED" &&
                  "This milestone is under dispute. Please wait for resolution."}
              </p>
            </CardContent>
          </Card>
        )}
