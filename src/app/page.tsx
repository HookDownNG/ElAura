      ...
      <nav className="fixed top-0 w-full bg-white/80 backdrop-blur-md border-b border-green-100 z-50 transition-all">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3 group cursor-pointer">
            <div className="w-9 h-9 bg-green-600 rounded-xl flex items-center justify-center text-white shadow-sm shadow-green-200 group-hover:scale-105 transition-transform">
              <svg
                className="w-5 h-5"
                fill="none"
                stroke="currentColor"
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-gray-600">
            {[
              ...
              <a
                ...
                className="hover:text-green-600 transition-colors relative after:absolute after:bottom-0 after:left-0 after:h-[2px] after:w-0 hover:after:w-full after:bg-green-500 after:transition-all"
              >
                {link}
              </a>
            ))}
          ...
          <div className="flex items-center gap-3">
            ...
            <button className="bg-green-600 text-white px-6 py-2.5 rounded-full font-medium flex items-center gap-2 hover:shadow-lg hover:shadow-green-100 hover:scale-[1.02] transition-all">
              Get in touch
              <svg
                className="w-4 h-4"
                fill="none"
